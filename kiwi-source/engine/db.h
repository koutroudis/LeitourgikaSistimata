...
pthread_mutex_t mergeSafe;//kleidaria gia thn prostasia tis domhs se periptwsh pou gemisei to memtable kai xreiazetai merge.
pthread_mutex_t mergeNumber;//kleidaria gia prostasia tis global test metavlhths.
pthread_cond_t mergeWait;//shma pou stelnete molis teleiwsei to merge
